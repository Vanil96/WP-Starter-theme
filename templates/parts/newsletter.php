<section class="cf7-custom cf7-box newsletter-container ">

    <div class="newsletter-container_left">
        <img class="logo" src="<?php echo imgPath('/webp/newsletter.webp'); ?>" alt="Newsletter">
    </div>

    <div class="newsletter-container_right">
        <div>
